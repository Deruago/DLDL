#include "DLDL_OOPSYNTAX/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_OOPSYNTAX::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_OOPSYNTAX::ast::listener::deamer::visualisation::Graph();
