#ifndef DLDL_LPDSTRUCT_BISON_PARSER_H
#define DLDL_LPDSTRUCT_BISON_PARSER_H

#include <Deamer/External/Cpp/Parser/Interface/Parser.h>

namespace DLDL_LPDSTRUCT { namespace bison { namespace parser {
...
#endif // DLDL_LPDSTRUCT_BISON_PARSER_H
