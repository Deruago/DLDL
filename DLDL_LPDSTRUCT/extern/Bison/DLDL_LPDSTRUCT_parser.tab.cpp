...
#line 1 "./DLDL_LPDSTRUCT_parser.y"
...
#line 119 "DLDL_LPDSTRUCT_parser.tab.c"
...
#line 80 "./DLDL_LPDSTRUCT_parser.y"
                                    {
...
#line 1127 "DLDL_LPDSTRUCT_parser.tab.c"
    break;

  case 3: /* deamerreserved_star__stmt__: stmt deamerreserved_star__stmt__  */
#line 88 "./DLDL_LPDSTRUCT_parser.y"
                                         {
		auto* const newNode = new DLDL_LPDSTRUCT::ast::node::deamerreserved_star__stmt__({::DLDL_LPDSTRUCT::ast::Type::deamerreserved_star__stmt__, ::deamer::external::cpp::ast::NodeValue::nonterminal, {0, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { (yyvsp[-1].DLDL_LPDSTRUCT_stmt), (yyvsp[0].DLDL_LPDSTRUCT_deamerreserved_star__stmt__) });
		(yyval.DLDL_LPDSTRUCT_deamerreserved_star__stmt__) = newNode;
	}
#line 1136 "DLDL_LPDSTRUCT_parser.tab.c"
    break;

  case 4: /* deamerreserved_star__stmt__: %empty  */
#line 92 "./DLDL_LPDSTRUCT_parser.y"
          {
		auto* const newNode = new DLDL_LPDSTRUCT::ast::node::deamerreserved_star__stmt__({::DLDL_LPDSTRUCT::ast::Type::deamerreserved_star__stmt__, ::deamer::external::cpp::ast::NodeValue::nonterminal, {1, ::deamer::external::cpp::ast::ProductionRuleType::user}}, {  });
		(yyval.DLDL_LPDSTRUCT_deamerreserved_star__stmt__) = newNode;
	}
#line 1145 "DLDL_LPDSTRUCT_parser.tab.c"
    break;
...
#line 1154 "DLDL_LPDSTRUCT_parser.tab.c"
    break;
...
#line 110 "./DLDL_LPDSTRUCT_parser.y"
                                             {
...
#line 1172 "DLDL_LPDSTRUCT_parser.tab.c"
    break;

  case 8: /* argument_name: VARNAME  */
#line 117 "./DLDL_LPDSTRUCT_parser.y"
                {
...
#line 1181 "DLDL_LPDSTRUCT_parser.tab.c"
    break;
...
#line 124 "./DLDL_LPDSTRUCT_parser.y"
                                                                                                                                                     {
...
#line 1190 "DLDL_LPDSTRUCT_parser.tab.c"
    break;
...
#line 1199 "DLDL_LPDSTRUCT_parser.tab.c"
    break;
...
#line 135 "./DLDL_LPDSTRUCT_parser.y"
                                                                                                                            {
		auto* const newNode = new DLDL_LPDSTRUCT::ast::node::deamerreserved_star__deamerreserved_or__INDENTED_VALUE__deamerreserved_or__VARNAME_EXT__VARNAME______({::DLDL_LPDSTRUCT::ast::Type::deamerreserved_star__deamerreserved_or__INDENTED_VALUE__deamerreserved_or__VARNAME_EXT__VARNAME______, ::deamer::external::cpp::ast::NodeValue::nonterminal, {1, ::deamer::external::cpp::ast::ProductionRuleType::user}}, { new DLDL_LPDSTRUCT::ast::node::VARNAME_EXT({::DLDL_LPDSTRUCT::ast::Type::VARNAME_EXT, ::deamer::external::cpp::ast::NodeValue::terminal, (yyvsp[-1].Terminal)}), (yyvsp[0].DLDL_LPDSTRUCT_deamerreserved_star__deamerreserved_or__INDENTED_VALUE__deamerreserved_or__VARNAME_EXT__VARNAME______) });
		(yyval.DLDL_LPDSTRUCT_deamerreserved_star__deamerreserved_or__INDENTED_VALUE__deamerreserved_or__VARNAME_EXT__VARNAME______) = newNode;
	}
#line 1208 "DLDL_LPDSTRUCT_parser.tab.c"
    break;
...
#line 139 "./DLDL_LPDSTRUCT_parser.y"
                                                                                                                        {
...
#line 1217 "DLDL_LPDSTRUCT_parser.tab.c"
    break;
...
#line 1226 "DLDL_LPDSTRUCT_parser.tab.c"
    break;


#line 1230 "DLDL_LPDSTRUCT_parser.tab.c"
...
#line 149 "./DLDL_LPDSTRUCT_parser.y"
