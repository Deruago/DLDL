...
namespace DLDL_LDOSTRUCT { namespace ast { namespace Visitor { 
	...
	public:
		void Dispatch(const ::deamer::external::cpp::ast::Node* node) override
		{
			...
			{
				Visit(static_cast<const DLDL_LDOSTRUCT::ast::node::VARNAME_EXT*>(node));
				break;
			}
			...
			{
				Visit(static_cast<const DLDL_LDOSTRUCT::ast::node::deamerreserved_star__deamerreserved_or__INDENTED_VALUE__deamerreserved_or__VARNAME_EXT__VARNAME______*>(node));
				break;
			}
			}
		}
		...
		virtual void Visit(const DLDL_LDOSTRUCT::ast::node::VARNAME_EXT* node)
		{
		}
		...
		virtual void Visit(const DLDL_LDOSTRUCT::ast::node::deamerreserved_star__deamerreserved_or__INDENTED_VALUE__deamerreserved_or__VARNAME_EXT__VARNAME______* node)
		{
		}
	};
