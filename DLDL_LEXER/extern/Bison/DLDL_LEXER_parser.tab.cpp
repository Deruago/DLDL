...
#line 122 "DLDL_LEXER_parser.tab.c"
...
{
       0,    91,    91,   102,   108,   118,   128,   134,   144,   150,
     156,   162,   168,   174
};
#endif
...
#line 91 "./DLDL_LEXER_parser.y"
               {
		auto* const newNode = new DLDL_LEXER::ast::node::program({::DLDL_LEXER::ast::Type::program, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (yyvsp[0].DLDL_LEXER_stmts) });
		(yyval.DLDL_LEXER_program) = newNode;

		// Ignored, Deleted, tokens are deleted
		outputTree = new ::deamer::external::cpp::ast::Tree(newNode);
	}
#line 1638 "DLDL_LEXER_parser.tab.c"
    break;

  case 3: /* stmts: stmt stmts  */
#line 102 "./DLDL_LEXER_parser.y"
                    {
...
#line 1649 "DLDL_LEXER_parser.tab.c"
    break;
...
#line 1660 "DLDL_LEXER_parser.tab.c"
    break;

  case 5: /* stmt: tokendeclaration  */
#line 118 "./DLDL_LEXER_parser.y"
                          {
...
#line 1671 "DLDL_LEXER_parser.tab.c"
    break;

  case 6: /* tokendeclaration: abstraction TERMINAL REGEX  */
#line 128 "./DLDL_LEXER_parser.y"
                                    {
...
#line 1682 "DLDL_LEXER_parser.tab.c"
    break;

  case 7: /* tokendeclaration: TERMINAL REGEX  */
#line 134 "./DLDL_LEXER_parser.y"
                          {
...
#line 1693 "DLDL_LEXER_parser.tab.c"
    break;

  case 8: /* abstraction: DELETE_ABSTRACTION  */
#line 144 "./DLDL_LEXER_parser.y"
                            {
...
#line 1704 "DLDL_LEXER_parser.tab.c"
    break;

  case 9: /* abstraction: IGNORE_ABSTRACTION  */
#line 150 "./DLDL_LEXER_parser.y"
                              {
...
#line 1715 "DLDL_LEXER_parser.tab.c"
    break;

  case 10: /* abstraction: CRASH_ABSTRACTION  */
#line 156 "./DLDL_LEXER_parser.y"
                             {
...
#line 1726 "DLDL_LEXER_parser.tab.c"
    break;

  case 11: /* abstraction: NOVALUE_ABSTRACTION  */
#line 162 "./DLDL_LEXER_parser.y"
                               {
...
#line 1737 "DLDL_LEXER_parser.tab.c"
    break;

  case 12: /* abstraction: STANDARD_ABSTRACTION  */
#line 168 "./DLDL_LEXER_parser.y"
                                {
...
#line 1748 "DLDL_LEXER_parser.tab.c"
    break;

  case 13: /* abstraction: UNKNOWN_ABSTRACTION  */
#line 174 "./DLDL_LEXER_parser.y"
                               {
...
#line 1759 "DLDL_LEXER_parser.tab.c"
    break;


#line 1763 "DLDL_LEXER_parser.tab.c"
