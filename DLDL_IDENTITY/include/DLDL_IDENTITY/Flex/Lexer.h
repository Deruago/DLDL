#ifndef DLDL_IDENTITY_FLEX_LEXER_H
#define DLDL_IDENTITY_FLEX_LEXER_H

#include <Deamer/External/Cpp/Lexer/Interface/Lexer.h>

namespace DLDL_IDENTITY { namespace flex { namespace lexer {
...
#endif // DLDL_IDENTITY_FLEX_LEXER_H
