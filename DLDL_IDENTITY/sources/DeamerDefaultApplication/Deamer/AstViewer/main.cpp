#include "DLDL_IDENTITY/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_IDENTITY::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_IDENTITY::ast::listener::deamer::visualisation::Graph();
