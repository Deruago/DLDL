#ifndef DLDL_GRAMMAR_PRODUCTION_RULE_FLEX_LEXER_H
#define DLDL_GRAMMAR_PRODUCTION_RULE_FLEX_LEXER_H

#include <Deamer/External/Cpp/Lexer/Interface/Lexer.h>

namespace DLDL_GRAMMAR_PRODUCTION_RULE { namespace flex { namespace lexer {
...
#endif // DLDL_GRAMMAR_PRODUCTION_RULE_FLEX_LEXER_H
