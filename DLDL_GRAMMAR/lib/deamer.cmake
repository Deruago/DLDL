...
file(GLOB_RECURSE HEADER_LIST "${DLDL_GRAMMAR_SOURCE_DIR}/include/*.h")

# Root library extension
DLDL_root_library_extend("DLDL_GRAMMAR" "${DLDL_GRAMMAR_SOURCE_DIR}/extern" "${DLDL_GRAMMAR_SOURCE_DIR}/include" "${SOURCE_LIST}")

add_library(DLDL_GRAMMAR_static_library ALIAS DLDL_static_library)