...
add_subdirectory(DLDL_GRAMMAR_PRODUCTION_RULE)

add_library(DLDL_GRAMMAR_external_libraries STATIC "${DLDL_GRAMMAR_SOURCE_DIR}/lib/DLDL_GRAMMAR.cpp")
target_link_libraries(DLDL_GRAMMAR_external_libraries PUBLIC Deamer_External)
target_include_directories(DLDL_GRAMMAR_external_libraries PUBLIC "${DLDL_GRAMMAR_SOURCE_DIR}/extern" "${DLDL_GRAMMAR_SOURCE_DIR}/include")
