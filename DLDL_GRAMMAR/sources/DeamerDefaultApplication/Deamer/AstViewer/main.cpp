#include "DLDL_GRAMMAR/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_GRAMMAR::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_GRAMMAR::ast::listener::deamer::visualisation::Graph();
