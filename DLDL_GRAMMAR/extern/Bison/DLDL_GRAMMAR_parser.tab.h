...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    UNKNOWN_ABSTRACTION = 260,     /* UNKNOWN_ABSTRACTION  */
    NONTERMINAL = 261,             /* NONTERMINAL  */
    PRODUCTION_RULE = 262          /* PRODUCTION_RULE  */
  };
...
#line 89 "DLDL_GRAMMAR_parser.tab.h"
