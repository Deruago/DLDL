...
#define yyparse         DLDLparse
#define yylex           DLDLlex
#define yyerror         DLDLerror
#define yydebug         DLDLdebug
#define yynerrs         DLDLnerrs
#define yylval          DLDLlval
#define yychar          DLDLchar

/* First part of user prologue.  */
#line 1 "./DLDL_parser.y"
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ANY", "$accept",
  "program", "stmts", "stmt", YY_NULLPTR
};
...
#line 1109 "DLDL_parser.tab.c"
    break;

  case 4: /* stmts: %empty  */
#line 63 "./DLDL_parser.y"
          {
...
#line 1127 "DLDL_parser.tab.c"
    break;


#line 1131 "DLDL_parser.tab.c"
...
deamer::external::cpp::ast::Tree* DLDL::parser::Parser::Parse(const std::string& text) const
{
	outputTree = nullptr;
	YY_BUFFER_STATE buf;
