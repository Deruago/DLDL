#ifndef DLDL_IMPORT_BISON_PARSER_H
#define DLDL_IMPORT_BISON_PARSER_H

#include <Deamer/External/Cpp/Parser/Interface/Parser.h>

namespace DLDL_IMPORT { namespace bison { namespace parser {
...
#endif // DLDL_IMPORT_BISON_PARSER_H
