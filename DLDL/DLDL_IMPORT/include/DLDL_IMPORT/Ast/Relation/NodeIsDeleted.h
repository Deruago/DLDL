#ifndef DLDL_IMPORT_AST_RELATION_NODEISDELETED_H
#define DLDL_IMPORT_AST_RELATION_NODEISDELETED_H

#include "DLDL_IMPORT/Ast/Enum/Type.h"

namespace DLDL_IMPORT { namespace ast { namespace relation { 

	constexpr static bool NodeIsDeleted(::DLDL_IMPORT::ast::Type t)
	{
...
#endif // DLDL_IMPORT_AST_RELATION_NODEISDELETED_H