...
#define yyparse DLDL_IDENTITYparse
#define yylex   DLDL_IDENTITYlex
#define yyerror DLDL_IDENTITYerror
#define yydebug DLDL_IDENTITYdebug
#define yylval  DLDL_IDENTITYlval
#define yychar  DLDL_IDENTITYchar
#define yynerrs DLDL_IDENTITYnerrs
...
#line 110 "DLDL_IDENTITY_parser.tab.c"
...
#include "DLDL_IDENTITY_parser.tab.h"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SYMBOLS = 5,                    /* SYMBOLS  */
  YYSYMBOL_ESCAPE_CHARS = 6,               /* ESCAPE_CHARS  */
  YYSYMBOL_YYACCEPT = 7,                   /* $accept  */
  YYSYMBOL_program = 8,                    /* program  */
  YYSYMBOL_stmts = 9,                      /* stmts  */
  YYSYMBOL_stmt = 10,                      /* stmt  */
  YYSYMBOL_name_declaration = 11           /* name_declaration  */
};
...
static const char *const yytname[] =
{
  ...
  "SYMBOLS", "ESCAPE_CHARS", "$accept", "program", "stmts", "stmt",
  "name_declaration", YY_NULLPTR
};
...
#line 79 "./DLDL_IDENTITY_parser.y"
               {
		auto* const newNode = new DLDL_IDENTITY::ast::node::program({::DLDL_IDENTITY::ast::Type::program, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_IDENTITY_stmts) });
		((*yyvalp).DLDL_IDENTITY_program) = newNode;

		// Ignored, Deleted, tokens are deleted
		outputTree = new ::deamer::external::cpp::ast::Tree(newNode);
	}
#line 1072 "DLDL_IDENTITY_parser.tab.c"
    break;

  case 3: /* stmts: stmt stmts  */
#line 90 "./DLDL_IDENTITY_parser.y"
                    {
		auto* const newNode = new DLDL_IDENTITY::ast::node::stmts({::DLDL_IDENTITY::ast::Type::stmts, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.DLDL_IDENTITY_stmt), (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_IDENTITY_stmts) });
		((*yyvalp).DLDL_IDENTITY_stmts) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1083 "DLDL_IDENTITY_parser.tab.c"
    break;

  case 4: /* stmts: %empty  */
#line 96 "./DLDL_IDENTITY_parser.y"
           {
...
#line 1094 "DLDL_IDENTITY_parser.tab.c"
    break;

  case 5: /* stmt: name_declaration  */
#line 106 "./DLDL_IDENTITY_parser.y"
                          {
		auto* const newNode = new DLDL_IDENTITY::ast::node::stmt({::DLDL_IDENTITY::ast::Type::stmt, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_IDENTITY_name_declaration) });
		((*yyvalp).DLDL_IDENTITY_stmt) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1105 "DLDL_IDENTITY_parser.tab.c"
    break;

  case 6: /* name_declaration: NAME VALUE  */
#line 116 "./DLDL_IDENTITY_parser.y"
                    {
		auto* const newNode = new DLDL_IDENTITY::ast::node::name_declaration({::DLDL_IDENTITY::ast::Type::name_declaration, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { new DLDL_IDENTITY::ast::node::NAME({::DLDL_IDENTITY::ast::Type::NAME, ::deamer::external::cpp::ast::NodeValue::terminal, (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.Terminal) }), new DLDL_IDENTITY::ast::node::VALUE({::DLDL_IDENTITY::ast::Type::VALUE, ::deamer::external::cpp::ast::NodeValue::terminal, (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.Terminal) }) });
		((*yyvalp).DLDL_IDENTITY_name_declaration) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1116 "DLDL_IDENTITY_parser.tab.c"
    break;


#line 1120 "DLDL_IDENTITY_parser.tab.c"
...
#line 126 "./DLDL_IDENTITY_parser.y"
