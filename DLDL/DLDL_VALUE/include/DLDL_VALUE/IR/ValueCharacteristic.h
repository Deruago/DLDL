#ifndef DLDL_VALUE_IR_VALUECHARACTERISTIC_H
#define DLDL_VALUE_IR_VALUECHARACTERISTIC_H
...
namespace DLDL::ir
{
	...
	public:
		ValueCharacteristic(const std::string& ruleName_);
...
#endif // DLDL_VALUE_IR_VALUECHARACTERISTIC_H
