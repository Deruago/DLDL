#ifndef DLDL_FILETEMPLATE_LEXICONTEMPLATE_h
#define DLDL_FILETEMPLATE_LEXICONTEMPLATE_h
...
case ::DLDL::filetemplate::LexiconTemplate::Type::language_full_name_slash_:
{
...
case ::DLDL::filetemplate::LexiconTemplate::Type::variable_regex_:
{
	...
	public:
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconTemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconTemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconTemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconTemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconTemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
...
*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("Lexicon") }));
...
{
	type = ::DLDL::filetemplate::LexiconTemplate::Type::language_full_name_slash_;
}

virtual ~Variable_language_full_name_slash_() override = default;

Variable_language_full_name_slash_(LexiconTemplate* lexicontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconTemplate::Type::language_full_name_slash_;
...
*variable_declaration_ = Variable_variable_declaration_(this, std::vector<VariableBase*>({ GenerateVariable("::deamer::type::SafeReserve<::deamer::language::type::definition::object::main::Terminal> "), GenerateVariable(variable_name_->This()), GenerateVariable(";") }));
...
#endif // DLDL_FILETEMPLATE_LEXICONTEMPLATE_h
