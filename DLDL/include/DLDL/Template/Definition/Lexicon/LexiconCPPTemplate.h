#ifndef DLDL_FILETEMPLATE_LEXICONCPPTEMPLATE_h
#define DLDL_FILETEMPLATE_LEXICONCPPTEMPLATE_h
...
namespace DLDL::filetemplate
{
	...
	/*!	\class LexiconCPPTemplate
	 *
	 *	\brief Generates code for "LexiconCPPTemplate"
	 *
...
Function_Field_Separator_,
		...
		static constexpr const char* ConvertEnumToName(::DLDL::filetemplate::LexiconCPPTemplate::Type enumerationValue)
{
	switch(enumerationValue)
	{
	case ::DLDL::filetemplate::LexiconCPPTemplate::Type::file_:
{
	return "file";
}

case ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_angle_bracket_:
{
	return "left_angle_bracket";
}

case ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_bracket_:
{
	return "left_bracket";
}

case ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_curly_bracket_:
{
	return "left_curly_bracket";
}

case ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_angle_bracket_:
{
	return "right_angle_bracket";
}

case ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_bracket_:
{
	return "right_bracket";
}

case ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_curly_bracket_:
{
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::LexiconCPPTemplate::Type type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::LexiconCPPTemplate::ScopeType scope_type = ::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::DLDL::filetemplate::LexiconCPPTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::DLDL::filetemplate::LexiconCPPTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;
			}
		};
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::DLDL::filetemplate::LexiconCPPTemplate::ScopeType::Variable_Field_Separator_, true);
...
{
	type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::file_;
}

virtual ~Variable_file_() override = default;

Variable_file_(LexiconCPPTemplate* lexiconcpptemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::file_;
...
Content_->type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;

*static_cast<VariableBase*>(Class_postfix_) = VariableBase(std::vector<VariableBase*>({  }));
Class_postfix_->type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;

*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("h") }));
Extension_->type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;

*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("LexiconCPP") }));
File_name_->type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;

*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("DLDL::filetemplate") }));
Namespace_->type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;

*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
Target_language_->type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::Scope;
...
{
	type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_angle_bracket_;
}

virtual ~Variable_left_angle_bracket_() override = default;

Variable_left_angle_bracket_(LexiconCPPTemplate* lexiconcpptemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_bracket_;
}

virtual ~Variable_left_bracket_() override = default;

Variable_left_bracket_(LexiconCPPTemplate* lexiconcpptemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_bracket_;
...
{
	type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_curly_bracket_;
}

virtual ~Variable_left_curly_bracket_() override = default;

Variable_left_curly_bracket_(LexiconCPPTemplate* lexiconcpptemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::left_curly_bracket_;
...
{
	type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_angle_bracket_;
}

virtual ~Variable_right_angle_bracket_() override = default;

Variable_right_angle_bracket_(LexiconCPPTemplate* lexiconcpptemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_bracket_;
}

virtual ~Variable_right_bracket_() override = default;

Variable_right_bracket_(LexiconCPPTemplate* lexiconcpptemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_bracket_;
...
{
	type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_curly_bracket_;
}

virtual ~Variable_right_curly_bracket_() override = default;

Variable_right_curly_bracket_(LexiconCPPTemplate* lexiconcpptemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::LexiconCPPTemplate::Type::right_curly_bracket_;
...
Variable_right_curly_bracket_& operator=(const Variable_right_curly_bracket_& variable)
{
	...
	public:
		...
		// e.g. LexiconCPPTemplate.member = "auto-generated";
...
#endif // DLDL_FILETEMPLATE_LEXICONCPPTEMPLATE_h
