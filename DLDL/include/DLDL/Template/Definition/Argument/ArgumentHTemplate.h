#ifndef DLDL_FILETEMPLATE_ARGUMENTHTEMPLATE_h
#define DLDL_FILETEMPLATE_ARGUMENTHTEMPLATE_h
...
namespace DLDL::filetemplate
{
	...
	/*!	\class ArgumentHTemplate
	 *
	 *	\brief Generates code for "ArgumentHTemplate"
	 *
...
Function_Field_Separator_,
		...
		static constexpr const char* ConvertEnumToName(::DLDL::filetemplate::ArgumentHTemplate::Type enumerationValue)
{
	switch(enumerationValue)
	{
	case ::DLDL::filetemplate::ArgumentHTemplate::Type::Unknown: {
		return "Unknown";}

	case ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope: {
		return "Scope";}

	case ::DLDL::filetemplate::ArgumentHTemplate::Type::file_:
{
	return "file";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::header_guard_:
{
	return "header_guard";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_:
{
	return "language_full_name";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_slash_:
{
	return "language_full_name_slash";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_underscore_:
{
	return "language_full_name_underscore";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::left_angle_bracket_:
{
	return "left_angle_bracket";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::left_bracket_:
{
	return "left_bracket";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::left_curly_bracket_:
{
	return "left_curly_bracket";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::right_angle_bracket_:
{
	return "right_angle_bracket";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::right_bracket_:
{
	return "right_bracket";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::right_curly_bracket_:
{
	return "right_curly_bracket";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::unknown_reference_:
{
	return "unknown_reference";
}

case ::DLDL::filetemplate::ArgumentHTemplate::Type::unknown_reference_declaration_:
{
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::ArgumentHTemplate::Type type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::ArgumentHTemplate::ScopeType scope_type = ::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::DLDL::filetemplate::ArgumentHTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::DLDL::filetemplate::ArgumentHTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;
			}
		};
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::DLDL::filetemplate::ArgumentHTemplate::ScopeType::Variable_Field_Separator_, true);
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::file_;
}

virtual ~Variable_file_() override = default;

Variable_file_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::file_;
*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("/* \n * This file is auto-generated and auto-maintained by DLDL\n * Do not change code in this as it can be overwritten"), GenerateVariable("."), GenerateVariable("\n *\n * For more information see the DLDL repo: https://github"), GenerateVariable("."), GenerateVariable("com/Deruago/DLDL\n * For more information about Deamer: https://github"), GenerateVariable("."), GenerateVariable("com/Deruago/theDeamerProject\n */\n\n#ifndef "), GenerateVariable(argumenthtemplate_->header_guard_->This()), GenerateVariable("\n#define "), GenerateVariable(argumenthtemplate_->header_guard_->This()), GenerateVariable("\n\n#include \"Deamer/Language/Generator/Definition/Property/User/Main/Argument"), GenerateVariable("."), GenerateVariable("h\"\n#include \"Deamer/Language/Type/Definition/Object/Special/Uninitialized"), GenerateVariable("."), GenerateVariable("h\"\n\nnamespace "), GenerateVariable(argumenthtemplate_->language_full_name_->This()), GenerateVariable("\n"), GenerateVariable("{"), GenerateVariable("\n\tclass Language;\n\n\tclass Argument : public ::deamer::language::generator::definition::property::user::Argument<\n\t\t\t\t\t\t\t\t::"), GenerateVariable(argumenthtemplate_->language_full_name_->This()), GenerateVariable("::Language>\n\t"), GenerateVariable("{"), GenerateVariable("\n\tpublic:\n\n\tprivate:\n\t\t"), GenerateVariable(argumenthtemplate_->unknown_reference_declaration_->Variable_Field()), GenerateVariable("\n\n\tpublic:\n\t\tArgument("), GenerateVariable(argumenthtemplate_->language_full_name_->This()), GenerateVariable("::Language* language);\n\t\t\n\t\tvoid GenerateObjects() override;\n\t"), GenerateVariable("}"), GenerateVariable(";\n"), GenerateVariable("}"), GenerateVariable("\n\n#endif // "), GenerateVariable(argumenthtemplate_->header_guard_->This()), GenerateVariable("\n") }));
Content_->type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;

*static_cast<VariableBase*>(Class_postfix_) = VariableBase(std::vector<VariableBase*>({  }));
Class_postfix_->type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;

*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("h") }));
Extension_->type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;

*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("ArgumentH") }));
File_name_->type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;

*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("DLDL::filetemplate") }));
Namespace_->type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;

*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
Target_language_->type = ::DLDL::filetemplate::ArgumentHTemplate::Type::Scope;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::header_guard_;
}

virtual ~Variable_header_guard_() override = default;

Variable_header_guard_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::header_guard_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_;
}

virtual ~Variable_language_full_name_() override = default;

Variable_language_full_name_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_slash_;
}

virtual ~Variable_language_full_name_slash_() override = default;

Variable_language_full_name_slash_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_slash_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_underscore_;
}

virtual ~Variable_language_full_name_underscore_() override = default;

Variable_language_full_name_underscore_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::language_full_name_underscore_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::left_angle_bracket_;
}

virtual ~Variable_left_angle_bracket_() override = default;

Variable_left_angle_bracket_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::left_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::left_bracket_;
}

virtual ~Variable_left_bracket_() override = default;

Variable_left_bracket_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::left_bracket_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::left_curly_bracket_;
}

virtual ~Variable_left_curly_bracket_() override = default;

Variable_left_curly_bracket_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::left_curly_bracket_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::right_angle_bracket_;
}

virtual ~Variable_right_angle_bracket_() override = default;

Variable_right_angle_bracket_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::right_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::right_bracket_;
}

virtual ~Variable_right_bracket_() override = default;

Variable_right_bracket_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::right_bracket_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::right_curly_bracket_;
}

virtual ~Variable_right_curly_bracket_() override = default;

Variable_right_curly_bracket_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::right_curly_bracket_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::unknown_reference_;
}

virtual ~Variable_unknown_reference_() override = default;

Variable_unknown_reference_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::unknown_reference_;
...
{
	type = ::DLDL::filetemplate::ArgumentHTemplate::Type::unknown_reference_declaration_;
}

virtual ~Variable_unknown_reference_declaration_() override = default;

Variable_unknown_reference_declaration_(ArgumentHTemplate* argumenthtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::ArgumentHTemplate::Type::unknown_reference_declaration_;
...
Variable_unknown_reference_declaration_& operator=(const Variable_unknown_reference_declaration_& variable)
{
	...
	public:
		...
		// e.g. ArgumentHTemplate.member = "auto-generated";
...
*header_guard_ = Variable_header_guard_(this, std::vector<VariableBase*>({ GenerateVariable(language_full_name_underscore_->Upper()), GenerateVariable("_ARGUMENT_H") }));
...
#endif // DLDL_FILETEMPLATE_ARGUMENTHTEMPLATE_h
