#ifndef DLDL_FILETEMPLATE_IDENTITYTEMPLATE_h
#define DLDL_FILETEMPLATE_IDENTITYTEMPLATE_h
...
namespace DLDL::filetemplate
{
	...
	public:
		...
		ConvertEnumToName(::DLDL::filetemplate::IdentityTemplate::Type enumerationValue)
		{
			...
			case ::DLDL::filetemplate::IdentityTemplate::Type::language_full_name_slash_: {
	...
	public:
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityTemplate::ScopeType::Upper_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityTemplate::ScopeType::Lower_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityTemplate::ScopeType::Snake_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityTemplate::ScopeType::Slash_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityTemplate::ScopeType::DoubleColon_,
								true),
				  base(base_)
			{
			}
	...
	public:
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(
					 ...
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\tpublic:\r\n\t\t::deamer::type::SafeReserve<::deamer::"
									  "language::type::definition::object::main::Name> "
									  "name;\r\n\r\n\tpublic:\r\n\t\tIdentity(::"),
					 GenerateVariable(identitytemplate_->language_full_name_->This()),
					 GenerateVariable("::Language* "
				...
				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("Identity")}));
		...
		struct Variable_language_full_name_slash_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityTemplate::Type::language_full_name_slash_;
			}

			virtual ~Variable_language_full_name_slash_() override = default;

			Variable_language_full_name_slash_(IdentityTemplate* identitytemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::IdentityTemplate::Type::language_full_name_slash_;
...
#endif // DLDL_FILETEMPLATE_IDENTITYTEMPLATE_h
