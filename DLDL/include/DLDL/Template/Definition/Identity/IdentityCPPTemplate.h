#ifndef DLDL_FILETEMPLATE_IDENTITYCPPTEMPLATE_h
#define DLDL_FILETEMPLATE_IDENTITYCPPTEMPLATE_h
...
{
	/*!	\class IdentityCPPTemplate
	 *
	 *	\brief Generates code for "IdentityCPPTemplate"
	 *
	...
	public:
		...
		ConvertEnumToName(::DLDL::filetemplate::IdentityCPPTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::DLDL::filetemplate::IdentityCPPTemplate::Type::file_: {
				return "file";
			}

			case ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_angle_bracket_: {
				return "left_angle_bracket";
			}

			case ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_bracket_: {
				return "left_bracket";
			}

			case ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_curly_bracket_: {
				return "left_curly_bracket";
			}

			case ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_angle_bracket_: {
				return "right_angle_bracket";
			}

			case ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_bracket_: {
				return "right_bracket";
			}

			case ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_curly_bracket_: {
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::IdentityCPPTemplate::Type type =
				::DLDL::filetemplate::IdentityCPPTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::IdentityCPPTemplate::ScopeType scope_type =
				::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::IdentityCPPTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::DLDL::filetemplate::IdentityCPPTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Upper_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Lower_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Snake_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Slash_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::DoubleColon_,
								true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope(
				"\n",
				::DLDL::filetemplate::IdentityCPPTemplate::ScopeType::Variable_Field_Separator_,
				true);
	...
	public:
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(IdentityCPPTemplate* identitycpptemplate_,
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
				...
				Content_->type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Class_postfix_) =
					VariableBase(std::vector<VariableBase*>({}));
				Class_postfix_->type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("h")}));
				Extension_->type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("IdentityCPP")}));
				File_name_->type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("DLDL::filetemplate")}));
				Namespace_->type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Target_language_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("C++")}));
				Target_language_->type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::Scope;
			}
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(IdentityCPPTemplate* identitycpptemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(IdentityCPPTemplate* identitycpptemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(IdentityCPPTemplate* identitycpptemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::left_curly_bracket_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(IdentityCPPTemplate* identitycpptemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_bracket_;
			}

			virtual ~Variable_right_bracket_() override = default;

			Variable_right_bracket_(IdentityCPPTemplate* identitycpptemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(IdentityCPPTemplate* identitycpptemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::IdentityCPPTemplate::Type::right_curly_bracket_;
	...
	public:
		...
		// e.g. IdentityCPPTemplate.member = "auto-generated";
...
#endif // DLDL_FILETEMPLATE_IDENTITYCPPTEMPLATE_h
