#ifndef DLDL_FILETEMPLATE_LPD_ENUMERATION_LDOTEMPLATE_h
#define DLDL_FILETEMPLATE_LPD_ENUMERATION_LDOTEMPLATE_h
...
namespace DLDL::filetemplate::lpd::enumeration
{
	...
	/*!	\class LDOTemplate
	 *
	 *	\brief Generates code for "LDOTemplate"
	 *
...
Function_Field_Separator_,
		...
		static constexpr const char* ConvertEnumToName(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type enumerationValue)
{
	switch(enumerationValue)
	{
	case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::file_:
{
	return "file";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::header_guard_:
{
	return "header_guard";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::ldo_group_:
{
	return "ldo_group";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::ldo_name_:
{
	return "ldo_name";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_angle_bracket_:
{
	return "left_angle_bracket";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_bracket_:
{
	return "left_bracket";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_curly_bracket_:
{
	return "left_curly_bracket";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::lpd_ldo_member_:
{
	return "lpd_ldo_member";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::lpd_name_:
{
	return "lpd_name";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_angle_bracket_:
{
	return "right_angle_bracket";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_bracket_:
{
	return "right_bracket";
}

case ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_curly_bracket_:
{
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType scope_type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::Scope;
			}
		};
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::ScopeType::Variable_Field_Separator_, true);
...
Namespace_->type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::Scope;

*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
Target_language_->type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::Scope;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::header_guard_;
}

virtual ~Variable_header_guard_() override = default;

Variable_header_guard_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::header_guard_;
...
struct Variable_ldo_group_ : public VariableScopes
{

static constexpr auto name = "ldo_group_";



Variable_ldo_group_() : VariableScopes()
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::ldo_group_;
}

virtual ~Variable_ldo_group_() override = default;

Variable_ldo_group_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::ldo_group_;
...
Variable_ldo_group_& operator=(const Variable_ldo_group_& variable)
{
	if (&variable == this)
	{
		return *this;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::ldo_name_;
}

virtual ~Variable_ldo_name_() override = default;

Variable_ldo_name_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::ldo_name_;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_angle_bracket_;
}

virtual ~Variable_left_angle_bracket_() override = default;

Variable_left_angle_bracket_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_bracket_;
}

virtual ~Variable_left_bracket_() override = default;

Variable_left_bracket_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_curly_bracket_;
}

virtual ~Variable_left_curly_bracket_() override = default;

Variable_left_curly_bracket_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::left_curly_bracket_;
...
struct Variable_lpd_ldo_member_ : public VariableScopes
{

static constexpr auto name = "lpd_ldo_member_";



Variable_lpd_ldo_member_() : VariableScopes()
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::lpd_ldo_member_;
}

virtual ~Variable_lpd_ldo_member_() override = default;

Variable_lpd_ldo_member_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::lpd_ldo_member_;
...
Variable_lpd_ldo_member_& operator=(const Variable_lpd_ldo_member_& variable)
{
	if (&variable == this)
	{
		return *this;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::lpd_name_;
}

virtual ~Variable_lpd_name_() override = default;

Variable_lpd_name_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::lpd_name_;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_angle_bracket_;
}

virtual ~Variable_right_angle_bracket_() override = default;

Variable_right_angle_bracket_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_bracket_;
}

virtual ~Variable_right_bracket_() override = default;

Variable_right_bracket_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_curly_bracket_;
}

virtual ~Variable_right_curly_bracket_() override = default;

Variable_right_curly_bracket_(LDOTemplate* ldotemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::enumeration::LDOTemplate::Type::right_curly_bracket_;
...
Variable_lpd_ldo_member_* lpd_ldo_member_ = new Variable_lpd_ldo_member_();
...
*header_guard_ = Variable_header_guard_(this, std::vector<VariableBase*>({ GenerateVariable("DEAMER_LANGUAGE_DATASTRUCTURE_DEFINITION_OBJECT_TYPE_H") }));
*ldo_group_ = Variable_ldo_group_(this, std::vector<VariableBase*>({ GenerateVariable("\n\t\t// "), GenerateVariable(lpd_name_->This()), GenerateVariable("\n"), GenerateVariable(lpd_ldo_member_->Variable_Field()), GenerateVariable("\n") }));
...
*lpd_ldo_member_ = Variable_lpd_ldo_member_(this, std::vector<VariableBase*>({ GenerateVariable("\t\t"), GenerateVariable(ldo_name_->This()), GenerateVariable(",") }));
...
variables_.emplace_back(ldo_group_);
...
variables_.emplace_back(lpd_ldo_member_);
...
#endif // DLDL_FILETEMPLATE_LPD_ENUMERATION_LDOTEMPLATE_h
