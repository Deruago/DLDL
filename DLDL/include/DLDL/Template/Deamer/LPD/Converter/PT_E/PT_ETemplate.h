#ifndef DLDL_FILETEMPLATE_LPD_CONVERTER_PT_ETEMPLATE_h
#define DLDL_FILETEMPLATE_LPD_CONVERTER_PT_ETEMPLATE_h
...
namespace DLDL::filetemplate::lpd::converter
{
	...
	/*!	\class PT_ETemplate
	 *
	 *	\brief Generates code for "PT_ETemplate"
	 *
...
Function_Field_Separator_,
		...
		static constexpr const char* ConvertEnumToName(::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type enumerationValue)
{
	switch(enumerationValue)
	{
	case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::explicit_lpd_namespace_:
{
	return "explicit_lpd_namespace";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::explicit_lpd_namespace_dispatch_:
{
	return "explicit_lpd_namespace_dispatch";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::file_:
{
	return "file";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::header_guard_:
{
	return "header_guard";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_angle_bracket_:
{
	return "left_angle_bracket";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_bracket_:
{
	return "left_bracket";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_curly_bracket_:
{
	return "left_curly_bracket";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_impl_:
{
	return "loc_impl";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_main_:
{
	return "loc_main";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_tool_:
{
	return "loc_tool";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::location_:
{
	return "location";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_forward_declaration_:
{
	return "lpd_forward_declaration";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_implementation_:
{
	return "lpd_implementation";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_name_:
{
	return "lpd_name";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_angle_bracket_:
{
	return "right_angle_bracket";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_bracket_:
{
	return "right_bracket";
}

case ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_curly_bracket_:
{
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType scope_type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;
			}

			VariableScope(const char* text, ::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;
			}
		};
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::DLDL::filetemplate::lpd::converter::PT_ETemplate::ScopeType::Variable_Field_Separator_, true);
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::explicit_lpd_namespace_;
}

virtual ~Variable_explicit_lpd_namespace_() override = default;

Variable_explicit_lpd_namespace_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::explicit_lpd_namespace_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::explicit_lpd_namespace_dispatch_;
}

virtual ~Variable_explicit_lpd_namespace_dispatch_() override = default;

Variable_explicit_lpd_namespace_dispatch_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::explicit_lpd_namespace_dispatch_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::file_;
}

virtual ~Variable_file_() override = default;

Variable_file_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::file_;
*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("/*\n * This program is free software; you can redistribute it and/or\n * modify it under the terms of the GNU General Public License\n * as published by the Free Software Foundation; either version 3\n * of the License, or (at your option) any later version"), GenerateVariable("."), GenerateVariable("\n *\n * This program is distributed in the hope that it will be useful,\n * but WITHOUT ANY WARRANTY; without even the implied warranty of\n * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE"), GenerateVariable("."), GenerateVariable("  See the\n * GNU General Public License for more details"), GenerateVariable("."), GenerateVariable("\n *\n * You should have received a copy of the GNU General Public License\n * along with this program; if not, write to the Free Software Foundation,\n * Inc"), GenerateVariable("."), GenerateVariable(", 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA"), GenerateVariable("."), GenerateVariable("\n */\n/*\n * Part of the DeamerProject"), GenerateVariable("."), GenerateVariable("\n * For more information go to: https://github"), GenerateVariable("."), GenerateVariable("com/Deruago/theDeamerProject\n */\n\n#ifndef "), GenerateVariable(pt_etemplate_->header_guard_->This()), GenerateVariable("\n#define "), GenerateVariable(pt_etemplate_->header_guard_->This()), GenerateVariable("\n\n#include \"Deamer/Language/Type/Definition/Property/Type"), GenerateVariable("."), GenerateVariable("h\"\n\n"), GenerateVariable(pt_etemplate_->lpd_forward_declaration_->Variable_Field()), GenerateVariable("\n\nnamespace deamer::language::convertor::definition\n"), GenerateVariable("{"), GenerateVariable("\n\t/*! "), GenerateVariable("\\"), GenerateVariable("class PropertyTypeToEnum\n\t *\n\t *\t"), GenerateVariable("\\"), GenerateVariable("brief This class is used to convert property types into their enum counterparts"), GenerateVariable("."), GenerateVariable("\n\t *\n\t *\t"), GenerateVariable("\\"), GenerateVariable("note This class functions on compile time using constexpr"), GenerateVariable("."), GenerateVariable("\n\t *\n\t *\t"), GenerateVariable("\\"), GenerateVariable("tparam T The type that needs to be converted to an enum value"), GenerateVariable("."), GenerateVariable("\n\t *\n\t *\t"), GenerateVariable("\\"), GenerateVariable("see deamer::language::convertor::definition::PropertyEnumToType\n\t */\n\ttemplate<typename T>\n\tclass PropertyTypeToEnum\n\t"), GenerateVariable("{"), GenerateVariable("\n\tpublic:\n\t\tconstexpr static auto value = type::definition::property::Type::Unknown;\n\t\tusing type = T;\n\t"), GenerateVariable("}"), GenerateVariable(";\n\n"), GenerateVariable(pt_etemplate_->lpd_implementation_->Variable_Field()), GenerateVariable("\n"), GenerateVariable("}"), GenerateVariable("\n\n#endif // "), GenerateVariable(pt_etemplate_->header_guard_->This()), GenerateVariable("\n") }));
Content_->type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;

*static_cast<VariableBase*>(Class_postfix_) = VariableBase(std::vector<VariableBase*>({  }));
Class_postfix_->type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;

*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("h") }));
Extension_->type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;

*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("PT_E") }));
File_name_->type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;
...
Namespace_->type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;

*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
Target_language_->type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::Scope;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::header_guard_;
}

virtual ~Variable_header_guard_() override = default;

Variable_header_guard_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::header_guard_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_angle_bracket_;
}

virtual ~Variable_left_angle_bracket_() override = default;

Variable_left_angle_bracket_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_bracket_;
}

virtual ~Variable_left_bracket_() override = default;

Variable_left_bracket_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_curly_bracket_;
}

virtual ~Variable_left_curly_bracket_() override = default;

Variable_left_curly_bracket_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::left_curly_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_impl_;
}

virtual ~Variable_loc_impl_() override = default;

Variable_loc_impl_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_impl_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_main_;
}

virtual ~Variable_loc_main_() override = default;

Variable_loc_main_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_main_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_tool_;
}

virtual ~Variable_loc_tool_() override = default;

Variable_loc_tool_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::loc_tool_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::location_;
}

virtual ~Variable_location_() override = default;

Variable_location_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::location_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_forward_declaration_;
}

virtual ~Variable_lpd_forward_declaration_() override = default;

Variable_lpd_forward_declaration_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_forward_declaration_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_implementation_;
}

virtual ~Variable_lpd_implementation_() override = default;

Variable_lpd_implementation_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_implementation_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_name_;
}

virtual ~Variable_lpd_name_() override = default;

Variable_lpd_name_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::lpd_name_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_angle_bracket_;
}

virtual ~Variable_right_angle_bracket_() override = default;

Variable_right_angle_bracket_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_bracket_;
}

virtual ~Variable_right_bracket_() override = default;

Variable_right_bracket_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_curly_bracket_;
}

virtual ~Variable_right_curly_bracket_() override = default;

Variable_right_curly_bracket_(PT_ETemplate* pt_etemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::converter::PT_ETemplate::Type::right_curly_bracket_;
...
Variable_right_curly_bracket_& operator=(const Variable_right_curly_bracket_& variable)
{
	...
	public:
		...
		// e.g. PT_ETemplate.member = "auto-generated";
...
*header_guard_ = Variable_header_guard_(this, std::vector<VariableBase*>({ GenerateVariable("DEAMER_LANGUAGE_CONVERTOR_DEFINITION_PROPERTYTYPETOENUM_H") }));
...
#endif // DLDL_FILETEMPLATE_LPD_CONVERTER_PT_ETEMPLATE_h
