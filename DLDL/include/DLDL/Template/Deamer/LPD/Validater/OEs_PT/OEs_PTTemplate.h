#ifndef DLDL_FILETEMPLATE_LPD_VALIDATER_OES_PTTEMPLATE_h
#define DLDL_FILETEMPLATE_LPD_VALIDATER_OES_PTTEMPLATE_h

#include <variant>
#include <vector>
#include <string>

namespace DLDL::filetemplate::lpd::validater
{

	/*!	\class OEs_PTTemplate
	 *
	 *	\brief Generates code for "OEs_PTTemplate"
	 *
...
Function_Field_Separator_,
		...
		static constexpr const char* ConvertEnumToName(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type enumerationValue)
{
	switch(enumerationValue)
	{
	case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::comma_extension_:
{
	return "comma_extension";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::explicit_lpd_namespace_:
{
	return "explicit_lpd_namespace";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::explicit_lpd_namespace_dispatch_:
{
	return "explicit_lpd_namespace_dispatch";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::file_:
{
	return "file";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::header_guard_:
{
	return "header_guard";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::ldo_implementation_:
{
	return "ldo_implementation";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::ldo_name_:
{
	return "ldo_name";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_angle_bracket_:
{
	return "left_angle_bracket";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_bracket_:
{
	return "left_bracket";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_curly_bracket_:
{
	return "left_curly_bracket";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_impl_:
{
	return "loc_impl";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_main_:
{
	return "loc_main";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_tool_:
{
	return "loc_tool";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::location_:
{
	return "location";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_implementation_:
{
	return "lpd_implementation";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_include_:
{
	return "lpd_include";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_name_:
{
	return "lpd_name";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::optional_comma_extension_:
{
	return "optional_comma_extension";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_angle_bracket_:
{
	return "right_angle_bracket";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_bracket_:
{
	return "right_bracket";
}

case ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_curly_bracket_:
{
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType scope_type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;
			}
		};
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::ScopeType::Variable_Field_Separator_, true);
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::comma_extension_;
}

virtual ~Variable_comma_extension_() override = default;

Variable_comma_extension_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::comma_extension_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::explicit_lpd_namespace_;
}

virtual ~Variable_explicit_lpd_namespace_() override = default;

Variable_explicit_lpd_namespace_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::explicit_lpd_namespace_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::explicit_lpd_namespace_dispatch_;
}

virtual ~Variable_explicit_lpd_namespace_dispatch_() override = default;

Variable_explicit_lpd_namespace_dispatch_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::explicit_lpd_namespace_dispatch_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::file_;
}

virtual ~Variable_file_() override = default;

Variable_file_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::file_;
*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("/*\n * This program is free software; you can redistribute it and/or\n * modify it under the terms of the GNU General Public License\n * as published by the Free Software Foundation; either version 3\n * of the License, or (at your option) any later version"), GenerateVariable("."), GenerateVariable("\n *\n * This program is distributed in the hope that it will be useful,\n * but WITHOUT ANY WARRANTY; without even the implied warranty of\n * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE"), GenerateVariable("."), GenerateVariable("  See the\n * GNU General Public License for more details"), GenerateVariable("."), GenerateVariable("\n *\n * You should have received a copy of the GNU General Public License\n * along with this program; if not, write to the Free Software Foundation,\n * Inc"), GenerateVariable("."), GenerateVariable(", 51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA"), GenerateVariable("."), GenerateVariable("\n */\n/*\n * Part of the DeamerProject"), GenerateVariable("."), GenerateVariable("\n * For more information go to: https://github"), GenerateVariable("."), GenerateVariable("com/Deruago/theDeamerProject\n */\n\n#ifndef "), GenerateVariable(oes_pttemplate_->header_guard_->This()), GenerateVariable("\n#define "), GenerateVariable(oes_pttemplate_->header_guard_->This()), GenerateVariable("\n\n#include \"Deamer/Language/Type/Definition/Object/Type"), GenerateVariable("."), GenerateVariable("h\"\n"), GenerateVariable(oes_pttemplate_->lpd_include_->Variable_Field()), GenerateVariable("\n\nnamespace deamer::language::validator::definition\n"), GenerateVariable("{"), GenerateVariable("\n\ttemplate<typename T>\n\tclass GetObjectEnumsFromPropertyType\n\t"), GenerateVariable("{"), GenerateVariable("\n\tpublic:\n\t\tconstexpr static auto value = "), GenerateVariable("{"), GenerateVariable("type::definition::object::Type::Unknown"), GenerateVariable("}"), GenerateVariable(";\n\t\tusing type = void;\n\t"), GenerateVariable("}"), GenerateVariable(";\n\n\t"), GenerateVariable(oes_pttemplate_->lpd_implementation_->Variable_Field()), GenerateVariable("\n"), GenerateVariable("}"), GenerateVariable("\n\n#endif // "), GenerateVariable(oes_pttemplate_->header_guard_->This()), GenerateVariable("\n") }));
Content_->type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;

*static_cast<VariableBase*>(Class_postfix_) = VariableBase(std::vector<VariableBase*>({  }));
Class_postfix_->type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;

*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("h") }));
Extension_->type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;

*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("OEs_PT") }));
File_name_->type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;

*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("DLDL::filetemplate::lpd::validater") }));
Namespace_->type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;

*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
Target_language_->type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::Scope;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::header_guard_;
}

virtual ~Variable_header_guard_() override = default;

Variable_header_guard_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::header_guard_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::ldo_implementation_;
}

virtual ~Variable_ldo_implementation_() override = default;

Variable_ldo_implementation_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::ldo_implementation_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::ldo_name_;
}

virtual ~Variable_ldo_name_() override = default;

Variable_ldo_name_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::ldo_name_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_angle_bracket_;
}

virtual ~Variable_left_angle_bracket_() override = default;

Variable_left_angle_bracket_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_bracket_;
}

virtual ~Variable_left_bracket_() override = default;

Variable_left_bracket_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_curly_bracket_;
}

virtual ~Variable_left_curly_bracket_() override = default;

Variable_left_curly_bracket_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::left_curly_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_impl_;
}

virtual ~Variable_loc_impl_() override = default;

Variable_loc_impl_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_impl_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_main_;
}

virtual ~Variable_loc_main_() override = default;

Variable_loc_main_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_main_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_tool_;
}

virtual ~Variable_loc_tool_() override = default;

Variable_loc_tool_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::loc_tool_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::location_;
}

virtual ~Variable_location_() override = default;

Variable_location_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::location_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_implementation_;
}

virtual ~Variable_lpd_implementation_() override = default;

Variable_lpd_implementation_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_implementation_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_include_;
}

virtual ~Variable_lpd_include_() override = default;

Variable_lpd_include_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_include_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_name_;
}

virtual ~Variable_lpd_name_() override = default;

Variable_lpd_name_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::lpd_name_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::optional_comma_extension_;
}

virtual ~Variable_optional_comma_extension_() override = default;

Variable_optional_comma_extension_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::optional_comma_extension_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_angle_bracket_;
}

virtual ~Variable_right_angle_bracket_() override = default;

Variable_right_angle_bracket_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_angle_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_bracket_;
}

virtual ~Variable_right_bracket_() override = default;

Variable_right_bracket_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_bracket_;
...
{
	type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_curly_bracket_;
}

virtual ~Variable_right_curly_bracket_() override = default;

Variable_right_curly_bracket_(OEs_PTTemplate* oes_pttemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::DLDL::filetemplate::lpd::validater::OEs_PTTemplate::Type::right_curly_bracket_;
...
Variable_right_curly_bracket_& operator=(const Variable_right_curly_bracket_& variable)
{
	...
	public:
		...
		// e.g. OEs_PTTemplate.member = "auto-generated";
...
*header_guard_ = Variable_header_guard_(this, std::vector<VariableBase*>({ GenerateVariable("DEAMER_LANGUAGE_VALIDATOR_DEFINITION_GETOBJECTENUMSFROMPROPERTYTYPE_H") }));
*ldo_implementation_ = Variable_ldo_implementation_(this, std::vector<VariableBase*>({ GenerateVariable(optional_comma_extension_->This()), GenerateVariable("type::definition::object::Type::"), GenerateVariable(ldo_name_->This()) }));
...
*lpd_implementation_ = Variable_lpd_implementation_(this, std::vector<VariableBase*>({ GenerateVariable("\ntemplate<>\n\tclass GetObjectEnumsFromPropertyType<type::definition::property::"), GenerateVariable(location_->This()), GenerateVariable("::"), GenerateVariable(lpd_name_->This()), GenerateVariable(">\n\t"), GenerateVariable("{"), GenerateVariable("\n\tpublic:\n\t\tconstexpr static auto value = "), GenerateVariable("{"), GenerateVariable(" "), GenerateVariable(ldo_implementation_->Variable_Field()), GenerateVariable(" "), GenerateVariable("}"), GenerateVariable(";\n\t\tusing type = type::definition::property::"), GenerateVariable(location_->This()), GenerateVariable("::"), GenerateVariable(lpd_name_->This()), GenerateVariable(";\n\t"), GenerateVariable("}"), GenerateVariable(";\n") }));
...
*optional_comma_extension_ = Variable_optional_comma_extension_(this, std::vector<VariableBase*>({ GenerateVariable("comma_extension") }));
...
#endif // DLDL_FILETEMPLATE_LPD_VALIDATER_OES_PTTEMPLATE_h
