#include "DLDL_LPDDEF_EF/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_LPDDEF_EF::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_LPDDEF_EF::ast::listener::deamer::visualisation::Graph();
