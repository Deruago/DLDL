#ifndef DLDL_LPDDEF_DF_BISON_PARSER_H
#define DLDL_LPDDEF_DF_BISON_PARSER_H

#include <Deamer/External/Cpp/Parser/Interface/Parser.h>

namespace DLDL_LPDDEF_DF { namespace bison { namespace parser {
...
#endif // DLDL_LPDDEF_DF_BISON_PARSER_H
