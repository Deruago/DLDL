#ifndef DLDL_LPDDEF_DF_FLEX_LEXER_H
#define DLDL_LPDDEF_DF_FLEX_LEXER_H

#include <Deamer/External/Cpp/Lexer/Interface/Lexer.h>

namespace DLDL_LPDDEF_DF { namespace flex { namespace lexer {
...
#endif // DLDL_LPDDEF_DF_FLEX_LEXER_H
