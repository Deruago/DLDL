...
file(GLOB_RECURSE SOURCE_LIST "${DLDL_LPDDEF_SOURCE_DIR}/lib/*.cpp")
file(GLOB_RECURSE HEADER_LIST "${DLDL_LPDDEF_SOURCE_DIR}/include/*.h")

# Root library extension
DLDL_root_library_extend("DLDL_LPDDEF" "${DLDL_LPDDEF_SOURCE_DIR}/extern" "${DLDL_LPDDEF_SOURCE_DIR}/include" "${SOURCE_LIST}")

add_library(DLDL_LPDDEF_static_library ALIAS DLDL_static_library)