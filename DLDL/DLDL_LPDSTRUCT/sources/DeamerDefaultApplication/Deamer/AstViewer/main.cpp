#include "DLDL_LPDSTRUCT/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_LPDSTRUCT::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_LPDSTRUCT::ast::listener::deamer::visualisation::Graph();
