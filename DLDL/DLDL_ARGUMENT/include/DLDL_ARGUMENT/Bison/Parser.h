#ifndef DLDL_ARGUMENT_BISON_PARSER_H
#define DLDL_ARGUMENT_BISON_PARSER_H

#include <Deamer/External/Cpp/Parser/Interface/Parser.h>

namespace DLDL_ARGUMENT { namespace bison { namespace parser {
...
#endif // DLDL_ARGUMENT_BISON_PARSER_H
