#ifndef DLDL_GRAMMAR_BISON_PARSER_H
#define DLDL_GRAMMAR_BISON_PARSER_H

#include <Deamer/External/Cpp/Parser/Interface/Parser.h>

namespace DLDL_GRAMMAR { namespace bison { namespace parser {
...
#endif // DLDL_GRAMMAR_BISON_PARSER_H
