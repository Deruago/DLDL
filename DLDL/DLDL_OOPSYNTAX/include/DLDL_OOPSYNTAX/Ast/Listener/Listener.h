...
namespace DLDL_OOPSYNTAX { namespace ast { namespace listener { 
	...
	public:
		void Dispatch(const ::deamer::external::cpp::ast::Node* node) override
		{
			...
			{
				Listen(static_cast<const DLDL_OOPSYNTAX::ast::node::deamerreserved_star__production_rule_conversion__*>(node));
				DefaultAction(node);
				break;
			}
			...
			{
				Listen(static_cast<const DLDL_OOPSYNTAX::ast::node::deamerreserved_star__property_assignment__*>(node));
				DefaultAction(node);
				break;
			}
		...
		virtual void Listen(const DLDL_OOPSYNTAX::ast::node::deamerreserved_star__production_rule_conversion__* node)
		{
		}
		...
		virtual void Listen(const DLDL_OOPSYNTAX::ast::node::deamerreserved_star__property_assignment__* node)
		{
		}
