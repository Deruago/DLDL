#ifndef DLDL_LDOSTRUCT_BISON_PARSER_H
#define DLDL_LDOSTRUCT_BISON_PARSER_H

#include <Deamer/External/Cpp/Parser/Interface/Parser.h>

namespace DLDL_LDOSTRUCT { namespace bison { namespace parser {
...
#endif // DLDL_LDOSTRUCT_BISON_PARSER_H
