...
#define yyparse DLDL_LDOSTRUCTparse
#define yylex   DLDL_LDOSTRUCTlex
#define yyerror DLDL_LDOSTRUCTerror
#define yydebug DLDL_LDOSTRUCTdebug
#define yylval  DLDL_LDOSTRUCTlval
#define yychar  DLDL_LDOSTRUCTchar
#define yynerrs DLDL_LDOSTRUCTnerrs
...
#line 116 "DLDL_LDOSTRUCT_parser.tab.c"
...
#include "DLDL_LDOSTRUCT_parser.tab.h"
...
#line 97 "./DLDL_LDOSTRUCT_parser.y"
                                     {
		auto* const newNode = new DLDL_LDOSTRUCT::ast::node::program({::DLDL_LDOSTRUCT::ast::Type::program, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_deamerreserved_star__stmt__) });
		((*yyvalp).DLDL_LDOSTRUCT_program) = newNode;

		// Ignored, Deleted, tokens are deleted
		outputTree = new ::deamer::external::cpp::ast::Tree(newNode);
	}
#line 1095 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 3: /* deamerreserved_star__stmt__: stmt deamerreserved_star__stmt__  */
#line 108 "./DLDL_LDOSTRUCT_parser.y"
                                          {
		auto* const newNode = new DLDL_LDOSTRUCT::ast::node::deamerreserved_star__stmt__({::DLDL_LDOSTRUCT::ast::Type::deamerreserved_star__stmt__, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::translation }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_stmt), (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_deamerreserved_star__stmt__) });
		((*yyvalp).DLDL_LDOSTRUCT_deamerreserved_star__stmt__) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1106 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 4: /* deamerreserved_star__stmt__: %empty  */
#line 114 "./DLDL_LDOSTRUCT_parser.y"
           {
...
#line 1117 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 5: /* stmt: argument  */
#line 124 "./DLDL_LDOSTRUCT_parser.y"
                  {
		auto* const newNode = new DLDL_LDOSTRUCT::ast::node::stmt({::DLDL_LDOSTRUCT::ast::Type::stmt, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_argument) });
		((*yyvalp).DLDL_LDOSTRUCT_stmt) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1128 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 6: /* argument: argument_name COLON VARNAME  */
#line 134 "./DLDL_LDOSTRUCT_parser.y"
                                     {
		auto* const newNode = new DLDL_LDOSTRUCT::ast::node::argument({::DLDL_LDOSTRUCT::ast::Type::argument, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-2)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_argument_name), new DLDL_LDOSTRUCT::ast::node::VARNAME({::DLDL_LDOSTRUCT::ast::Type::VARNAME, ::deamer::external::cpp::ast::NodeValue::terminal, (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.Terminal) }) });
		((*yyvalp).DLDL_LDOSTRUCT_argument) = newNode;

		// Ignored, Deleted, tokens are deleted
		delete (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.Terminal);
	}
#line 1140 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 7: /* argument: argument_name COLON argument_block  */
#line 141 "./DLDL_LDOSTRUCT_parser.y"
                                              {
		auto* const newNode = new DLDL_LDOSTRUCT::ast::node::argument({::DLDL_LDOSTRUCT::ast::Type::argument, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 1, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-2)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_argument_name), (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_argument_block) });
		((*yyvalp).DLDL_LDOSTRUCT_argument) = newNode;

		// Ignored, Deleted, tokens are deleted
		delete (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.Terminal);
	}
#line 1152 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 8: /* argument_name: VARNAME  */
#line 152 "./DLDL_LDOSTRUCT_parser.y"
                 {
		...
		((*yyvalp).DLDL_LDOSTRUCT_argument_name) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1163 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 9: /* argument_block: LEFT_ANGLE_BRACKET deamerreserved_star__argument_stmt__ RIGHT_ANGLE_BRACKET  */
#line 162 "./DLDL_LDOSTRUCT_parser.y"
                                                                                     {
		auto* const newNode = new DLDL_LDOSTRUCT::ast::node::argument_block({::DLDL_LDOSTRUCT::ast::Type::argument_block, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.DLDL_LDOSTRUCT_deamerreserved_star__argument_stmt__) });
		((*yyvalp).DLDL_LDOSTRUCT_argument_block) = newNode;
...
#line 1198 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 12: /* argument_stmt: INDENTED_VALUE  */
#line 190 "./DLDL_LDOSTRUCT_parser.y"
                        {
		auto* const newNode = new DLDL_LDOSTRUCT::ast::node::argument_stmt({::DLDL_LDOSTRUCT::ast::Type::argument_stmt, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { new DLDL_LDOSTRUCT::ast::node::INDENTED_VALUE({::DLDL_LDOSTRUCT::ast::Type::INDENTED_VALUE, ::deamer::external::cpp::ast::NodeValue::terminal, (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.Terminal) }) });
		((*yyvalp).DLDL_LDOSTRUCT_argument_stmt) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1209 "DLDL_LDOSTRUCT_parser.tab.c"
    break;

  case 13: /* argument_stmt: VARNAME  */
#line 196 "./DLDL_LDOSTRUCT_parser.y"
                   {
...
#line 1220 "DLDL_LDOSTRUCT_parser.tab.c"
    break;


#line 1224 "DLDL_LDOSTRUCT_parser.tab.c"
...
#line 206 "./DLDL_LDOSTRUCT_parser.y"
