#include "DLDL_LDOSTRUCT/Ast/Visualisation/Graph.h"
#include "DLDL_LDOSTRUCT/Bison/Parser.h"
#include "DLDL_LDOSTRUCT/Ast/Relation/NodeEnumToText.h"
#include <fstream>
#include <iostream>
#include <sstream>
#include <vector>
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_LDOSTRUCT::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_LDOSTRUCT::ast::listener::deamer::visualisation::Graph();
