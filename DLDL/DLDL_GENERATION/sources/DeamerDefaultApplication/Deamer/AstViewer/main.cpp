#include "DLDL_GENERATION/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_GENERATION::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_GENERATION::ast::listener::deamer::visualisation::Graph();
