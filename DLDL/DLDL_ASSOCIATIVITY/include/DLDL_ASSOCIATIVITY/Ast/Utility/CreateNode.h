#ifndef DLDL_ASSOCIATIVITY_AST_UTILITY_CREATENODE_H
#define DLDL_ASSOCIATIVITY_AST_UTILITY_CREATENODE_H
...
namespace DLDL_ASSOCIATIVITY { namespace ast { namespace utility { 
	...
	public:
		...
		{
			switch(static_cast<::DLDL_ASSOCIATIVITY::ast::Type>(nodeType))
			{
			case ::DLDL_ASSOCIATIVITY::ast::Type::deamerreserved_unknown: {
			...
			case ::DLDL_ASSOCIATIVITY::ast::Type::ASSOCIATIVITY: {
				return new ::DLDL_ASSOCIATIVITY::ast::node::ASSOCIATIVITY({nodeType, ::deamer::external::cpp::ast::NodeValue::terminal, nodeValue, lineNumber, columnNumber});
			}
			case ::DLDL_ASSOCIATIVITY::ast::Type::program: {
				return new ::DLDL_ASSOCIATIVITY::ast::node::program({nodeType, ::deamer::external::cpp::ast::NodeValue::nonterminal, {productionRuleId, productionRuleType}}, nodes);
			}
			case ::DLDL_ASSOCIATIVITY::ast::Type::stmts: {
				return new ::DLDL_ASSOCIATIVITY::ast::node::stmts({nodeType, ::deamer::external::cpp::ast::NodeValue::nonterminal, {productionRuleId, productionRuleType}}, nodes);
			}
			case ::DLDL_ASSOCIATIVITY::ast::Type::stmt: {
				return new ::DLDL_ASSOCIATIVITY::ast::node::stmt({nodeType, ::deamer::external::cpp::ast::NodeValue::nonterminal, {productionRuleId, productionRuleType}}, nodes);
			}
...
#endif // DLDL_ASSOCIATIVITY_AST_UTILITY_CREATENODE_H