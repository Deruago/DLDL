...
#define yyparse DLDL_ASSOCIATIVITYparse
#define yylex   DLDL_ASSOCIATIVITYlex
#define yyerror DLDL_ASSOCIATIVITYerror
#define yydebug DLDL_ASSOCIATIVITYdebug
#define yylval  DLDL_ASSOCIATIVITYlval
#define yychar  DLDL_ASSOCIATIVITYchar
#define yynerrs DLDL_ASSOCIATIVITYnerrs

/* First part of user prologue.  */
#line 5 "./DLDL_ASSOCIATIVITY_parser.y"
...
#line 106 "DLDL_ASSOCIATIVITY_parser.tab.c"
...
#include "DLDL_ASSOCIATIVITY_parser.tab.h"
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ASSOCIATIVITY = 3,              /* ASSOCIATIVITY  */
  YYSYMBOL_YYACCEPT = 4,                   /* $accept  */
  YYSYMBOL_program = 5,                    /* program  */
  YYSYMBOL_stmts = 6,                      /* stmts  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ASSOCIATIVITY",
  "$accept", "program", "stmts", "stmt", YY_NULLPTR
};
...
#line 67 "./DLDL_ASSOCIATIVITY_parser.y"
               {
		auto* const newNode = new DLDL_ASSOCIATIVITY::ast::node::program({::DLDL_ASSOCIATIVITY::ast::Type::program, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_ASSOCIATIVITY_stmts) });
		((*yyvalp).DLDL_ASSOCIATIVITY_program) = newNode;

		// Ignored, Deleted, tokens are deleted
		outputTree = new ::deamer::external::cpp::ast::Tree(newNode);
	}
#line 1062 "DLDL_ASSOCIATIVITY_parser.tab.c"
    break;

  case 3: /* stmts: stmt stmts  */
#line 78 "./DLDL_ASSOCIATIVITY_parser.y"
                    {
		auto* const newNode = new DLDL_ASSOCIATIVITY::ast::node::stmts({::DLDL_ASSOCIATIVITY::ast::Type::stmts, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (-1)].yystate.yysemantics.yyval.DLDL_ASSOCIATIVITY_stmt), (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.DLDL_ASSOCIATIVITY_stmts) });
		((*yyvalp).DLDL_ASSOCIATIVITY_stmts) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1073 "DLDL_ASSOCIATIVITY_parser.tab.c"
    break;

  case 4: /* stmts: %empty  */
#line 84 "./DLDL_ASSOCIATIVITY_parser.y"
           {
...
#line 1084 "DLDL_ASSOCIATIVITY_parser.tab.c"
    break;

  case 5: /* stmt: ASSOCIATIVITY  */
#line 94 "./DLDL_ASSOCIATIVITY_parser.y"
                       {
		auto* const newNode = new DLDL_ASSOCIATIVITY::ast::node::stmt({::DLDL_ASSOCIATIVITY::ast::Type::stmt, ::deamer::external::cpp::ast::NodeValue::nonterminal, { 0, ::deamer::external::cpp::ast::ProductionRuleType::user }}, { new DLDL_ASSOCIATIVITY::ast::node::ASSOCIATIVITY({::DLDL_ASSOCIATIVITY::ast::Type::ASSOCIATIVITY, ::deamer::external::cpp::ast::NodeValue::terminal, (YY_CAST (yyGLRStackItem const *, yyvsp)[YYFILL (0)].yystate.yysemantics.yyval.Terminal) }) });
		((*yyvalp).DLDL_ASSOCIATIVITY_stmt) = newNode;

		// Ignored, Deleted, tokens are deleted
	}
#line 1095 "DLDL_ASSOCIATIVITY_parser.tab.c"
    break;


#line 1099 "DLDL_ASSOCIATIVITY_parser.tab.c"
...
#line 104 "./DLDL_ASSOCIATIVITY_parser.y"
