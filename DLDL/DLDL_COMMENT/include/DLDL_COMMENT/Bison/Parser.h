#ifndef DLDL_COMMENT_BISON_PARSER_H
#define DLDL_COMMENT_BISON_PARSER_H

#include <Deamer/External/Cpp/Parser/Interface/Parser.h>

namespace DLDL_COMMENT { namespace bison { namespace parser {
...
#endif // DLDL_COMMENT_BISON_PARSER_H
