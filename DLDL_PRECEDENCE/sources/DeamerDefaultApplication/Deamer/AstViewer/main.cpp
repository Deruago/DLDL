#include "DLDL_PRECEDENCE/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DLDL_PRECEDENCE::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DLDL_PRECEDENCE::ast::listener::deamer::visualisation::Graph();
