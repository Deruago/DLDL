	...
	public:
		...
		void DispatchEntry(const ::deamer::external::cpp::ast::Node* node) 
		{
			...
			case DLDL_LPDDEF::ast::Type::VARNAME_EXT:
			{
				...
				EnterAnything(node);
				EnterTerminal(node);
				ListenEntry(static_cast<const DLDL_LPDDEF::ast::node::VARNAME_EXT*>(node));
				break;
			}
		...
		void DispatchExit(const ::deamer::external::cpp::ast::Node* node) 
		{
			...
			{
				// Exit terminal
				ListenExit(static_cast<const DLDL_LPDDEF::ast::node::VARNAME_EXT*>(node));
				ExitTerminal(node);
				ExitAnything(node);
				break;
			}
		...
		virtual void ListenEntry(const DLDL_LPDDEF::ast::node::VARNAME_EXT* node) 
		{
		}
		...
		virtual void ListenExit(const DLDL_LPDDEF::ast::node::VARNAME_EXT* node) 
		{
		}
