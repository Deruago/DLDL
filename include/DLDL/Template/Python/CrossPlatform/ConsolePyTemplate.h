...
namespace DLDL::filetemplate
{
	...
	public:
		...
		ConvertEnumToName(::DLDL::filetemplate::ConsolePyTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::DLDL::filetemplate::ConsolePyTemplate::Type::debug_mode_: {
				return "debug_mode";
			}
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::ConsolePyTemplate::Type type =
				::DLDL::filetemplate::ConsolePyTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::ConsolePyTemplate::ScopeType scope_type =
				::DLDL::filetemplate::ConsolePyTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::ConsolePyTemplate::ScopeType scope_type_,
			...
			VariableScope(const char* text,
						  ::DLDL::filetemplate::ConsolePyTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::ConsolePyTemplate::ScopeType::DoubleColon_,
								true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::DLDL::filetemplate::ConsolePyTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::DLDL::filetemplate::ConsolePyTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope(
				"\n", ::DLDL::filetemplate::ConsolePyTemplate::ScopeType::Variable_Field_Separator_,
				true);
	...
	public:
		struct Variable_debug_mode_ : public VariableScopes
		{
			static constexpr auto name = "debug_mode_";

			Variable_debug_mode_() : VariableScopes()
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::debug_mode_;
			}

			virtual ~Variable_debug_mode_() override = default;

			Variable_debug_mode_(ConsolePyTemplate* consolepytemplate_,
			...
			Variable_debug_mode_& operator=(const Variable_debug_mode_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(ConsolePyTemplate* consolepytemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(
						 "import os\nimport sys\nimport shutil\nimport subprocess\n\n# This Python "
						 "Script utilizes the Python standard library to offer\n# A Cross Platform "
						 "OS support for console commands"),
					 GenerateVariable("."),
					 GenerateVariable("\n#\n# Deamer CC construct the argument input for this "
					 ...
					 GenerateVariable("."),
					 GenerateVariable("com/Deruago/theDeamerProject\n#\n# If you find some crucial "
									  "issue or bug please report it"),
					 GenerateVariable("."),
					 GenerateVariable(" By following the above link"),
					 GenerateVariable("."),
					 GenerateVariable("\n#\n\ndangerous_script = False\nour_os = \"\"\ntarget_os = "
									  "\"\"\npython_console_version = \"1"),
					 GenerateVariable("."),
					 GenerateVariable("0"),
					 GenerateVariable("."),
					 GenerateVariable("0\"\nuser_name = \"\"\ndebug_mode = "),
					 GenerateVariable(consolepytemplate_->debug_mode_->This()),
					 GenerateVariable(
						 "\n\ndef execute_setting(arg_os: str, arg_header: str, arg_content: "
						 "str):\n\tglobal dangerous_script\n\tglobal our_os\n\tglobal "
						 "target_os\n\tglobal user_name\n\tglobal debug_mode\n\n\tif arg_header == "
						 "\"DANGEROUS\":\n\t\t# Dangerous script should not continue if some error "
						 "occures\n\t\tif arg_content == \"TRUE\":\n\t\t\tdangerous_script = "
						 "True\n\t\telse:\n\t\t\tdangerous_script = False\n\tif arg_header == "
						 "\"OUR_OS\":\n\t\t# Specifies the OS the python script is executed "
						 "on\n\t\t# Required when target specific commands are "
						 "executed\n\t\tour_os = arg_content\n\tif arg_header == "
						 "\"THEIR_OR\":\n\t\t# Specifies the OS the python script should "
						 "target\n\t\t# Required when target specific commands are "
						 "executed\n\t\tour_os = arg_content\n\tif arg_header == "
						 "\"USER_NAME\":\n\t\t# Specifies the name of the user or application "
						 "which initiated this script\n\t\tuser_name = arg_content\n\tif "
						 "arg_header == \"DEBUG_MODE\":\n\t\t# Enable or Disable Debug "
						 "Mode\n\t\tif arg_content == \"TRUE\":\n\t\t\tdebug_mode = "
						 "True\n\t\telse:\n\t\t\tdebug_mode = False\n\ndef "
						 "execute_windows_arguments(arg_os: str, arg_header: str, arg_content: "
						 "str):\n\tglobal dangerous_script\n\tglobal our_os\n\tglobal "
						 ...
						 "cmd call\n\t\tos"),
					 GenerateVariable("."),
					 GenerateVariable("system(f'"),
					 GenerateVariable("{"),
					 GenerateVariable("arg_content"),
					 GenerateVariable("}"),
					 GenerateVariable(
						 "')\n\t\tpass\n\tif our_os == \"mac\":\n\t\t# No conversion "
						 "possible\n\t\tpass\n\tpass\n\ndef execute_linux_argument(arg_os: str, "
						 "arg_header: str, arg_content: str):\n\tglobal dangerous_script\n\tglobal "
						 "our_os\n\tglobal target_os\n\tglobal user_name\n\tglobal "
						 "python_console_version\n\tglobal debug_mode\n\n\tif our_os == "
					 ...
					 GenerateVariable(")')\n\t\tpass\n\tif our_os == \"windows\":\n\t\t# Try to "
									  "use WSL\n\t\tos"),
					 GenerateVariable("."),
					 GenerateVariable("system(f\"bash -c '("),
					 GenerateVariable("{"),
					 GenerateVariable("arg_content"),
					 GenerateVariable("}"),
					 GenerateVariable(
						 ")'\")\n\t\tpass\n\tif our_os == \"mac\":\n\t\t# No conversion "
						 "possible\n\t\tpass\n\tpass\n\ndef execute_mac_argument(arg_os: str, "
						 "arg_header: str, arg_content: str):\n\tglobal dangerous_script\n\tglobal "
						 "our_os\n\tglobal target_os\n\tglobal user_name\n\tglobal "
						 "python_console_version\n\tglobal debug_mode\n\n\tif our_os == "
					 ...
					 GenerateVariable("arg_content"),
					 GenerateVariable("}"),
					 GenerateVariable(")')\n\t\tpass\n\tpass\n\ndef find_executable(lhsPath: str, "
									  "file: str):\n\tfor root, dirs, files in os"),
					 GenerateVariable("."),
					 GenerateVariable("walk(lhsPath):\n\t\tif file in files:\n\t\t\treturn os"),
					 GenerateVariable("."),
					 GenerateVariable("path"),
					 GenerateVariable("."),
					 GenerateVariable(
						 "join(root, file)\n\traise Exception('Could not find file, this script is "
						 "maybe dangerous')\n\ndef execute_python_argument(arg_os: str, "
						 "arg_header: str, arg_content: str):\n\tglobal dangerous_script\n\tglobal "
						 "our_os\n\tglobal target_os\n\tglobal user_name\n\tglobal "
						 "python_console_version\n\tglobal debug_mode\n\n\tif "
						 "debug_mode:\n\t\tprint(f'"),
					 GenerateVariable("{"),
					 GenerateVariable("arg_os"),
					 GenerateVariable("}"),
					 GenerateVariable(" --- "),
					 GenerateVariable("{"),
					 GenerateVariable("arg_header"),
					 GenerateVariable("}"),
					 GenerateVariable(" --- "),
					 GenerateVariable("{"),
					 GenerateVariable("arg_content"),
					 GenerateVariable("}"),
					 GenerateVariable(
						 "')\n\tif arg_header == \"MOVEFILE\":\n\t\t# This will move the file to "
						 "the given path\n\t\t_, lhs_path, __, rhs_path, ___ = arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\tshutil"),
					 GenerateVariable("."),
					 GenerateVariable("move(lhs_path, rhs_path)\n\t\treturn\n\tif arg_header == "
									  "\"CD\":\n\t\t# This will change the directory to the given "
									  "path\n\t\t_, lhs_path, __ = arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\tos"),
					 GenerateVariable("."),
					 GenerateVariable("chdir(lhs_path)\n\t\treturn\n\tif arg_header == "
									  "\"REMFILE\":\n\t\t# This will remove the file at the given "
									  "path\n\t\t_, lhs_path, __ = arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\tos"),
					 GenerateVariable("."),
					 GenerateVariable("remove(lhs_path)\n\t\treturn\n\tif arg_header == "
									  "\"REMDIR\":\n\t\t# This will remove the directory at the "
									  "given path\n\t\t_, lhs_path, __ = arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\tshutil"),
					 GenerateVariable("."),
					 GenerateVariable("rmtree(lhs_path)\n\t\treturn\n\tif arg_header == "
									  "\"CREATEDIR\":\n\t\t# This will create the directory at the "
									  "given path\n\t\t_, lhs_path, __ = arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\tos"),
					 GenerateVariable("."),
					 GenerateVariable(
						 ...
						 "only run executables without other args"),
					 GenerateVariable("."),
					 GenerateVariable("\n\t\t_, lhs_path, __ = arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\texecutable = find_executable('"),
					 GenerateVariable("."),
					 GenerateVariable("/', lhs_path)\n\t\tsubprocess"),
					 GenerateVariable("."),
					 GenerateVariable("check_call([executable])\n\t\treturn\n\tif arg_header == "
									  "\"COPYFILE\":\n\t\t# This will copy the file to the given "
									  "path\n\t\t_, lhs_path, __, rhs_path, ___ = arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\tshutil"),
					 GenerateVariable("."),
					 GenerateVariable("copy(lhs_path, rhs_path)\n\t\treturn\n\tif arg_header == "
									  "\"COMMAND\":\n\t\t# It is assumed the command is cross "
									  "platform executable\n\t\t_, lhs_path, __= arg_content"),
					 GenerateVariable("."),
					 GenerateVariable("split('\"')\n\t\tos"),
					 GenerateVariable("."),
					 GenerateVariable(
						 "system(lhs_path)\n\t\treturn\n\tif arg_header == \"ECHO\":\n\t\t# This "
						 "will echo the given argument\n\t\t_, lhs_path, __= arg_content"),
					 GenerateVariable("."),
					 GenerateVariable(
						 "split('\"')\n\t\tprint(lhs_path)\n\t\treturn\n\tif arg_header == "
						 "\"VERSION\":\n\t\t# This will print the python script "
						 "version\n\t\tprint(python_console_version)\n\t\treturn\n\tprint("
						 "f\"Unknown Argument Header: "),
					 GenerateVariable("{"),
					 GenerateVariable("arg_header"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable("."),
					 GenerateVariable(
						 "\n\t#  - This variable is also used to specify if some setting must be "
						 "initialized\n\t# argument_header is the second word\n\t#  - Defines what "
						 "type of command is executed"),
					 GenerateVariable("."),
					 GenerateVariable(
						 "\n\t# argument_content the arguments for the command\n\targument_os, "
						 "argument_header, argument_content = arg"),
					 GenerateVariable("."),
					 GenerateVariable(
						 "split(\" \", 2)\n\t\n\t# Setup 1 setting\n\tif argument_os == "
						 "\"SETTING\":\n\t\texecute_setting(argument_os, argument_header, "
						 "argument_content)\n\t\treturn\n\tif argument_os == "
						 "\"windows\":\n\t\texecute_windows_argument(argument_os, argument_header, "
						 "argument_content)\n\t\treturn\n\tif argument_os == "
						 "\"linux\":\n\t\texecute_linux_argument(argument_os, argument_header, "
						 "argument_content)\n\t\treturn\n\tif argument_os == "
						 "\"mac\":\n\t\texecute_mac_argument(argument_os, argument_header, "
						 "argument_content)\n\t\treturn\n\t\n\ttry:\n\t\texecute_python_argument("
						 "argument_os, argument_header, argument_content)\n\texcept:\n\t\t# "
						 "print(f\"Command throwed exception"),
					 GenerateVariable("."),
					 GenerateVariable(" This python script might become dangerous\")\n\t\tif "
									  "dangerous_script:\n\t\t\tprint(\"As the script is dangerous "
									  "this script will not continue further!\")\n\t\t\tsys"),
					 GenerateVariable("."),
					 GenerateVariable("exit()\n\t\treturn\n\ndef main():\n\tglobal "
									  "debug_mode\n\tif debug_mode:\n\t\tprint('Entered Python "
									  "Console!')\n\n\tfirst = True\n\tfor argument in sys"),
					 GenerateVariable("."),
					 GenerateVariable("argv:\n\t\tif first:\n\t\t\tfirst = "
				...
				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("ConsolePy")}));
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(ConsolePyTemplate* consolepytemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(ConsolePyTemplate* consolepytemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(ConsolePyTemplate* consolepytemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::left_curly_bracket_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(ConsolePyTemplate* consolepytemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(ConsolePyTemplate* consolepytemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(ConsolePyTemplate* consolepytemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::ConsolePyTemplate::Type::right_curly_bracket_;
	...
	public:
		...
		Variable_debug_mode_* debug_mode_ = new Variable_debug_mode_();
	...
	public:
		...
		{
			*debug_mode_ =
				Variable_debug_mode_(this, std::vector<VariableBase*>({GenerateVariable("True")}));
			...
			*right_curly_bracket_ = Variable_right_curly_bracket_(
			...
			variables_.emplace_back(debug_mode_);
