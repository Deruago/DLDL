#ifndef DST_ROOTCMAKELISTSTTEMPLATE_h
#define DST_ROOTCMAKELISTSTTEMPLATE_h
...
namespace DLDL::filetemplate
{
	...
	/*!	\class RootCMakeListstTemplate
	 *
	 *	\brief Generates code for "RootCMakeListstTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(::DLDL::filetemplate::RootCMakeListstTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::file_:
			{
				return "file";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::language_:
			{
				return "language";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::language_directory_:
			{
				return "language_directory";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::languages_:
			{
				return "languages";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_angle_bracket_:
			{
				return "left_angle_bracket";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_bracket_:
			{
				return "left_bracket";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_curly_bracket_:
			{
				return "left_curly_bracket";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::project_name_:
			{
				return "project_name";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_angle_bracket_:
			{
				return "right_angle_bracket";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_bracket_:
			{
				return "right_bracket";
			}

			case ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_curly_bracket_:
			{
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::RootCMakeListstTemplate::Type type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType scope_type = ::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;
			}
		};
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType::Default_, true);
			VariableBase* upper_ = new VariableScope(::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType::Upper_, true);
			VariableBase* lower_ = new VariableScope(::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType::Lower_, true);
			VariableBase* variable_field_ = new VariableScope(::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::DLDL::filetemplate::RootCMakeListstTemplate::ScopeType::Variable_Field_Separator_, true);
	...
	public:
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("cmake_minimum_required(VERSION 3"), GenerateVariable("."), GenerateVariable("16)\r\n\r\nproject("), GenerateVariable(rootcmakeliststtemplate_->project_name_->This()), GenerateVariable("\r\n                      DESCRIPTION \"Project for the language(s): "), GenerateVariable(rootcmakeliststtemplate_->languages_->This()), GenerateVariable("\"\r\n                      LANGUAGES CXX)\r\n\r\nfind_package(Deamer REQUIRED)\r\n\r\nadd_subdirectory(CompilerGenerator)\r\n"), GenerateVariable(rootcmakeliststtemplate_->language_directory_->Variable_Field()) }));
				Content_->type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;

				*static_cast<VariableBase*>(Class_postfix_) = VariableBase(std::vector<VariableBase*>({  }));
				Class_postfix_->type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({  }));
				Extension_->type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({  }));
				File_name_->type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("DLDL::filetemplate") }));
				Namespace_->type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;

				*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({  }));
				Target_language_->type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::Scope;
		...
		struct Variable_language_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::language_;
			}

			virtual ~Variable_language_() override = default;

			Variable_language_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::language_;
		...
		struct Variable_language_directory_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::language_directory_;
			}

			virtual ~Variable_language_directory_() override = default;

			Variable_language_directory_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::language_directory_;
		...
		struct Variable_languages_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::languages_;
			}

			virtual ~Variable_languages_() override = default;

			Variable_languages_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::languages_;
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::left_curly_bracket_;
		...
		struct Variable_project_name_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::project_name_;
			}

			virtual ~Variable_project_name_() override = default;

			Variable_project_name_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::project_name_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_bracket_;
			}

			virtual ~Variable_right_bracket_() override = default;

			Variable_right_bracket_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(RootCMakeListstTemplate* rootcmakeliststtemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::RootCMakeListstTemplate::Type::right_curly_bracket_;
	...
	public:
		...
		// e.g. RootCMakeListstTemplate.member = "auto-generated";
	...
	public:
		RootCMakeListstTemplate()
		{
			*file_ = Variable_file_(this, std::vector<VariableBase*>({  }));
			*language_ = Variable_language_(this, std::vector<VariableBase*>({  }));
			*language_directory_ = Variable_language_directory_(this, std::vector<VariableBase*>({ GenerateVariable("add_subdirectory("), GenerateVariable(language_->This()), GenerateVariable(")") }));
			...
			*project_name_ = Variable_project_name_(this, std::vector<VariableBase*>({ GenerateVariable(languages_->This()), GenerateVariable("_LanguageProject") }));
		...
		virtual ~RootCMakeListstTemplate()
		{
