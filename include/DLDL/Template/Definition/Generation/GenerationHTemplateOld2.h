...
namespace DLDL::filetemplate
{
	...
	public:
		GenerationTemplate()
		{
			...
			*os_add_object_ = Variable_os_add_object_(this, std::vector<VariableBase*>({  }));
			...
			*os_implementation_ = Variable_os_implementation_(this, std::vector<VariableBase*>({ GenerateVariable("AddObject(os_"), GenerateVariable(os_type_->This()), GenerateVariable(");") }));
