#ifndef DLDL_FILETEMPLATE_GENERATIONCPPTEMPLATE_h
#define DLDL_FILETEMPLATE_GENERATIONCPPTEMPLATE_h
...
{
	/*!	\class GenerationCPPTemplate
	 *
	 *	\brief Generates code for "GenerationCPPTemplate"
	 *
	...
	public:
		...
		ConvertEnumToName(::DLDL::filetemplate::GenerationCPPTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::DLDL::filetemplate::GenerationCPPTemplate::Type::file_: {
				return "file";
			}

			case ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_angle_bracket_: {
				return "left_angle_bracket";
			}

			case ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_bracket_: {
				return "left_bracket";
			}

			case ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_curly_bracket_: {
				return "left_curly_bracket";
			}

			case ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_angle_bracket_: {
				return "right_angle_bracket";
			}

			case ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_bracket_: {
				return "right_bracket";
			}

			case ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_curly_bracket_: {
	...
	public:
		struct VariableBase
		{
			...
			::DLDL::filetemplate::GenerationCPPTemplate::Type type =
				::DLDL::filetemplate::GenerationCPPTemplate::Type::Unknown;
		...
		{
			::DLDL::filetemplate::GenerationCPPTemplate::ScopeType scope_type =
				::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DLDL::filetemplate::GenerationCPPTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::DLDL::filetemplate::GenerationCPPTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Upper_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Lower_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Snake_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Slash_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(
					  ::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::DoubleColon_, true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope(
				"\n",
				::DLDL::filetemplate::GenerationCPPTemplate::ScopeType::Variable_Field_Separator_,
				true);
	...
	public:
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(GenerationCPPTemplate* generationcpptemplate_,
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
				...
				Content_->type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Class_postfix_) =
					VariableBase(std::vector<VariableBase*>({}));
				Class_postfix_->type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("h")}));
				Extension_->type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("GenerationCPP")}));
				File_name_->type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("DLDL::filetemplate")}));
				Namespace_->type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::Scope;

				*static_cast<VariableBase*>(Target_language_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("C++")}));
				Target_language_->type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::Scope;
			}
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(GenerationCPPTemplate* generationcpptemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(GenerationCPPTemplate* generationcpptemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(GenerationCPPTemplate* generationcpptemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::left_curly_bracket_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(GenerationCPPTemplate* generationcpptemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_bracket_;
			}

			virtual ~Variable_right_bracket_() override = default;

			Variable_right_bracket_(GenerationCPPTemplate* generationcpptemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(GenerationCPPTemplate* generationcpptemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DLDL::filetemplate::GenerationCPPTemplate::Type::right_curly_bracket_;
	...
	public:
		...
		// e.g. GenerationCPPTemplate.member = "auto-generated";
...
#endif // DLDL_FILETEMPLATE_GENERATIONCPPTEMPLATE_h
